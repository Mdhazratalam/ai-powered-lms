    ...
    <footer className="bg-black text-gray-300 py-10 px-6">
      <div className="max-w-7xl mx-auto flex lg:items-center items-start justify-center gap-[40px] lg:gap-[150px] flex-col lg:flex-row">
        ...
        <div className="lg:w-[40%] md:w-[50%] w-[100%]">
          ...
          <h2 className="text-xl font-bold text-white mb-3">YOUR CAREER PATH</h2>
          <p className="text-sm">
        ...
        <div className="lg:w-[100%] md:w-[100%]">
          ...
          <ul className="space-y-1 text-sm">
            <li className="hover:text-white">📞 7091667895</li>
            <li className="hover:text-white">📧 alammdhazrat743@gmail.com</li>
          </ul>
        </div>
