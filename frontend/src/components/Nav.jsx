...
//           {/* ✅ AI Career Workflow button (desktop) */}
//           {userData && (
//             <span
//               className="px-[18px] py-[8px] border-2 border-white text-white rounded-[10px] text-[16px] font-light cursor-pointer bg-[#000000d5]"
//               onClick={() => navigate("/career-workflow")}
//             >
//               AI Career Workflow
//             </span>
//           )}
...
//         {/* ✅ AI Career Workflow (mobile) - only for logged-in users */}
//         {userData && (
//           <span
//             className="flex items-center justify-center gap-2 text-[18px] text-white border-[2px] border-[#fdfbfb7a] bg-[#000000d5] rounded-lg px-[40px] py-[20px]"
//             onClick={() => {
//               setShowHam(false);
//               navigate("/career-workflow");
//             }}
//           >
//             AI Career Workflow
//           </span>
