  ...
  return (
    ...
    <div className='w-[100%] overflow-hidden'>
      ...
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <span className='lg:text-[60px] absolute  md:text-[40px]  lg:top-[10%] top-[15%] w-[100%] flex items-center justify-center text-white font-bold text-[20px] '>
          Discover Courses That Take You Further
        </span>
